                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="category">Type d'abonnement <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="author" id="author" minlength="2"
                                        maxlength="" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="date_official">Date officielle de publication <span
